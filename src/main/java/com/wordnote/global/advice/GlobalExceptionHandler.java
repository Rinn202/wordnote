...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleAuth(AuthException ex) {
        ...
        return toResponse(ExceptionCode.AUTH_ERROR);
    }
    ...
    public ResponseEntity<?> handleDataException(DataIntegrityViolationException e) {

        Throwable root = (e.getRootCause() != null)
                ? e.getRootCause()
                : e.getMostSpecificCause();
        log.error("Unhandled data Exception: ", e);
    ...
    public ResponseEntity<?> handleNotFound(NoResourceFoundException e) {
        log.error("NoResource Exception: ", e);
