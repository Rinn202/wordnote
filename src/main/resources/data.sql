INSERT IGNORE INTO task (task_id, name, category, info, member_id) VALUES
    (1, '마약, 향정약 확인', '인수인계_상세', NULL, NULL),
...
INSERT IGNORE INTO board (board_id, member_id) VALUES (1, NULL);

-- 박스 (sortIndex는 순서대로)
INSERT IGNORE INTO box (box_id, board_id, box_type, name, sort_index) VALUES
    (1, 1, 'ROUTINE', '약품, 비품 인수인계', 0),
...
-- BoxTask
INSERT IGNORE INTO box_task (box_task_id, box_id, task_id, sort_index, is_done) VALUES
    (1, 1, 4, 0, false),
    (2, 2, 5, 0, false),
    (3, 2, 6, 1, false),
    (4, 2, 7, 2, false),
